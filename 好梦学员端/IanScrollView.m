...
//        slideImage.contentMode = UIViewContentModeScaleAspectFit;
        [slideImage sd_setImageWithURL:[NSURL URLWithString:_slideImagesArray[i]] placeholderImage:[UIImage imageNamed:@"pic06"]];
        slideImage.tag = i;
...
//    firstSlideImage.contentMode = UIViewContentModeScaleAspectFit;
    [firstSlideImage sd_setImageWithURL:[NSURL URLWithString:_slideImagesArray[_slideImagesArray.count - 1]] placeholderImage:[UIImage imageNamed:@"pic06"]];
...
//    endSlideImage.contentMode = UIViewContentModeScaleAspectFit;
    [endSlideImage sd_setImageWithURL:[NSURL URLWithString:_slideImagesArray[0]] placeholderImage:[UIImage imageNamed:@"pic06"]];
